...
for plugin in "hls-explicit-imports-plugin" "hls-retrie-plugin" "hls-class-plugin" "hls-haddock-comments-plugin" "hls-splice-plugin" "hls-eval-plugin" "hls-hlint-plugin" "hls-tactics-plugin"; do
